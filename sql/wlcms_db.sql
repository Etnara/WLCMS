...
--
-- Host: localhost
-- Generation Time: Dec 03, 2025 at 12:32 AM
...
(151, 'Leadership Basics', '2025-01-15', '09:00', '10:00', 'Leadership', 'speaker001', 50, 'No', 0, NULL, 'None', 'Coffee Talk'),
(152, 'Artificial Intelligence', '2025-01-22', '10:00', '11:00', 'AI', 'speaker002', 50, 'No', 0, NULL, 'None', 'Coffee Talk'),
(153, 'Mentorship Skills', '2025-01-29', '11:00', '12:00', 'Mentorship', 'speaker003', 50, 'No', 0, NULL, 'None', 'Coffee Talk');
...
('cow795f36', NULL, 'cow', 'cow cow', 'cow@gmail.com', '$2y$10$6uqHS0OIL/m79Bv/oqgaseO6/wuzTx0VvnG61jfo2GzXyka4h9A9q', '5557779090', 'alksdfj', 'waht', 'Pending Speaker', 0, NULL),
('e92a6112-cd81-11f0-a0d9-acde48001122', '2025-11-29', 'Emily', 'Rogers', 'emily.rogers@umw.edu', 'pw123', '5405552211', 'UMW', 'Marketing, Branding Strategy', 'Accepted Speaker', 0, ''),
('ee529c22-cd81-11f0-a0d9-acde48001122', '2025-11-29', 'Jordan', 'Lee', 'jordan.lee@cyber.org', 'securepw', '5405559988', 'CyberSafe Inc.', 'Cybersecurity, Risk Management', 'Accepted Speaker', 0, ''),
('f544878e-cd81-11f0-a0d9-acde48001122', '2025-11-29', 'Monica', 'Taylor', 'monica.taylor@leadershipco.com', 'leadpw', '5405551133', 'Leadership Co.', 'Leadership, Professional Communication', 'Accepted Speaker', 0, ''),
('lexcb1b84', NULL, 'lex', 'lex', 'lex@gmail.com', '$2y$10$q3UJxkCRRLiGOpjJfWJ/UuHqjdkdVrDm5l2Yt2HEFPWEHHarl9gzK', '5555452424', 'hi', 'alkhfalk', 'Pending Speaker', 0, NULL),
...
('speaker001', '2025-01-01', 'Emily', 'Rogers', 'emily.rogers@umw.edu', 'pw123', '5405550001', 'UMW', 'Leadership', 'Accepted Speaker', 0, NULL),
('speaker002', '2025-01-01', 'Jordan', 'Lee', 'jordan.lee@cyber.org', 'securepw', '5405550002', 'CyberOrg', 'AI', 'Accepted Speaker', 0, NULL),
('speaker003', '2025-01-01', 'Monica', 'Taylor', 'monica.taylor@leadershipco.com', 'leaderpw', '5405550003', 'LeadershipCo', 'Mentorship', 'Accepted Speaker', 0, NULL),
...
CREATE TABLE `dbsurveys` (
  ...
  `topic_rating` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `dbsurveys`
--

INSERT INTO `dbsurveys` (`id`, `filename`, `mime`, `content`, `uploaded_at`, `speaker_name`, `topic_title`, `talk_date`, `speaker_rating`, `topic_rating`) VALUES
(27, 'mentorship_skills.csv', 'text/csv', 0x537065616b657220526174696e672c546f70696320526174696e670a352c350a352c350a342c340a342c350a332c340a, '2025-12-01 13:11:57', 'Monica Taylor', 'Mentorship', '2025-01-29', 4, 5),
(28, 'artificial_intelligence.csv', 'text/csv', 0x537065616b657220526174696e672c546f70696320526174696e670a342c350a352c350a332c340a342c330a352c340a, '2025-12-01 13:12:08', 'Jordan Lee', 'AI', '2025-01-22', 4, 4),
(29, 'leadership_basics.csv', 'text/csv', 0x537065616b657220526174696e672c546f70696320526174696e670a352c340a342c340a352c350a332c340a342c350a, '2025-12-01 13:12:17', 'Emily Rogers', 'Leadership', '2025-01-15', 4, 4);
...
--
-- Dumping data for table `speaker_months`
--

INSERT INTO `speaker_months` (`id`, `month`) VALUES
('cow795f36', 'December'),
('lexcb1b84', 'February'),
('lexcb1b84', 'January'),
('lexcb1b84', 'May'),
