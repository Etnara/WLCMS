...
function connect() {
    ...
    $user     = "wlcms_db";
    $pass     = "wlcms_db";
    if (   isset($_SERVER['SERVER_NAME']) && $_SERVER['SERVER_NAME'] == 'jenniferp213.sg-host.com'    # For entire website
        || isset($_SERVER['SITE_NAME'])   && $_SERVER['SITE_NAME']   == 'jenniferp213.sg-host.com') { # For sendReminders.php
        $database = '--------------------';
        $user     = '--------------------';
        $pass     = '--------------------';
    }
